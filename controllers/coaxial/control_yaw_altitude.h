...
#ifndef _CONTROL_YAW_ALTITUDE_H_
#define _CONTROL_YAW_ALTITUDE_H_
 ...
 *
 * @param yaw			The current yaw angle in [rad] [-pi,pi]
 * @param yawRef		The yaw reference angle in [rad] [-pi,pi]
...
#endif /* _CONTROL_YAW_ALTITUDE_H_ */
