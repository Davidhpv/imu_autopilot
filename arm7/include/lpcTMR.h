...
#define PWMTCR_COUNTER_ENABLE (1 << 0) /* enable PWM timer counter */
#define PWMTCR_COUNTER_RESET  (1 << 1) /* reset PWM timer counter  */
...
#define PWMPCR_SEL2 (1 << 2)     /* select double edge for PWM2 output  */
#define PWMPCR_SEL3 (1 << 3)     /* select double edge for PWM3 output  */
#define PWMPCR_SEL4 (1 << 4)     /* select double edge for PWM4 output  */
#define PWMPCR_SEL5 (1 << 5)     /* select double edge for PWM5 output  */
#define PWMPCR_SEL6 (1 << 6)     /* select double edge for PWM6 output  */
#define PWMPCR_ENA1 (1 << 9)     /* PWM1 output enabled                 */
#define PWMPCR_ENA2 (1 << 10)    /* PWM2 output enabled                 */
#define PWMPCR_ENA3 (1 << 11)    /* PWM3 output enabled                 */
#define PWMPCR_ENA4 (1 << 12)    /* PWM4 output enabled                 */
#define PWMPCR_ENA5 (1 << 13)    /* PWM5 output enabled                 */
#define PWMPCR_ENA6 (1 << 14)    /* PWM6 output enabled                 */

/* PWMLER ( Latch Enable Register ) bit definitions */
#define PWMLER_LATCH0 (1 << 0)   /* latch last MATCH0 register value    */
#define PWMLER_LATCH1 (1 << 1)   /* latch last MATCH1 register value    */
#define PWMLER_LATCH2 (1 << 2)   /* latch last MATCH2 register value    */
#define PWMLER_LATCH3 (1 << 3)   /* latch last MATCH3 register value    */
#define PWMLER_LATCH4 (1 << 4)   /* latch last MATCH4 register value    */
#define PWMLER_LATCH5 (1 << 5)   /* latch last MATCH5 register value    */
#define PWMLER_LATCH6 (1 << 6)   /* latch last MATCH6 register value    */
