...
/** @addtogroup CMSIS_CM4_core_LintCinfiguration CMSIS CM4 Core Lint Configuration
 *
...
#define __CM4_CMSIS_VERSION_SUB   (0x40)                                                       /*!< [15:0]  CMSIS HAL sub version  */
 ...
 ******************************************************************************/
/** @addtogroup CMSIS_CM4_core_register CMSIS CM4 Core Register
 @{
*/
...
/** @addtogroup CMSIS_CM4_NVIC CMSIS CM4 NVIC
  memory mapped structure for Nested Vectored Interrupt Controller (NVIC)
  @{
 */
typedef struct
...
/*@}*/ /* end of group CMSIS_CM4_NVIC */


/** @addtogroup CMSIS_CM4_SCB CMSIS CM4 SCB
...
typedef struct
{
  ...
  __IO uint32_t CPACR;                        /*!< Offset: 0x88  Coprocessor access register                           */
} SCB_Type;                                                
...
/*@}*/ /* end of group CMSIS_CM4_SCB */


/** @addtogroup CMSIS_CM4_SysTick CMSIS CM4 SysTick
...
/*@}*/ /* end of group CMSIS_CM4_SysTick */


/** @addtogroup CMSIS_CM4_ITM CMSIS CM4 ITM
...
/*@}*/ /* end of group CMSIS_CM4_ITM */


/** @addtogroup CMSIS_CM4_InterruptType CMSIS CM4 Interrupt Type
...
/*@}*/ /* end of group CMSIS_CM4_InterruptType */


#if defined (__MPU_PRESENT) && (__MPU_PRESENT == 1)
/** @addtogroup CMSIS_CM4_MPU CMSIS CM4 MPU
...
/*@}*/ /* end of group CMSIS_CM4_MPU */
#endif


#if defined (__FPU_PRESENT) && (__FPU_PRESENT == 1)
/** @addtogroup CMSIS_CM4_FPU CMSIS CM4 FPU
  memory mapped structure for Floating Point Unit (PPU)
  @{
 */
typedef struct
{
       uint32_t RESERVED0[1];                                 
  __IO uint32_t FPCCR;                        /*!< Offset: 0x04  Floating point context control register               */
  __IO uint32_t FPCAR;                        /*!< Offset: 0x08  Floating point context address register               */
  __IO uint32_t FPDSCR;                       /*!< Offset: 0x0C  Floating point default status control register        */
  __IO uint32_t MVFR0;                        /*!< Offset: 0x10  Media and VFP feature register 0                      */
  __IO uint32_t MVFR1;                        /*!< Offset: 0x14  Media and VFP feature register 1                      */
} FPU_Type;                                                

/*@}*/ /* end of group CMSIS_CM4_FPU */
#endif


/** @addtogroup CMSIS_CM4_CoreDebug CMSIS CM4 Core Debug
...
/*@}*/ /* end of group CMSIS_CM4_CoreDebug */
...
/*@}*/ /* end of group CMSIS_CM4_core_register */
...
/* ###################  Compiler specific DSP SIMD Intrinsics  ################## */
#include "core_cm4_dsp.h"





/** @addtogroup CMSIS_CM4_Core_FunctionInterface CMSIS CM4 Core Function Interface
...
/*@}*/ /* end of group CMSIS_CM4_Core_FunctionInterface */



/* ##################################### Debug In/Output function ########################################### */

/** @addtogroup CMSIS_CM4_CoreDebugInterface CMSIS CM4 Core Debug Interface
...
/*@}*/ /* end of group CMSIS_CM4_core_DebugInterface */
...
/*@}*/ /* end of group CMSIS_CM4_core_definitions */
